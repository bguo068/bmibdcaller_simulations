...
class SimParams(CheckableParams):
    def __init__(self) -> None:
        ...
        self.u = 1e-8
        self.nsam = 1000
        self.slim_script = str(slim_script_dir / "human_uk_pop.slim")
    ...
    def prepare_args(self):
        ...
        # add gc
        p.add_argument("--gc", type=int, default=d["gc"])
...
class SlimMsprimeSimulatorForHumanUKPop:
    def __init__(
        self,
        params: SimParams,
    ):
    ...
    def simulate_a_chromosome(
        ...
        rts: tskit.TreeSequence = pyslim.recapitate(
            ...
            ancestral_Ne=24_000,  # https://www.cell.com/ajhg/fulltext/S0002-9297(20)30052-5#secsectitle0020
...
if __name__ == "__main__":
    ...
    simulator = SlimMsprimeSimulatorForHumanUKPop(params)
