...
def get_args(cmd_args=None):
    ...
    parser.add_argument("--bp_per_cm", type=float, required=True)
    parser.add_argument("--seqlen_in_cm", type=float, required=True)
...
write.table(my_ibd, "{chrno}.ibd", sep='\t', quote=F, row.names=F)
"""
